...
if xbmc.getCondVisibility('system.platform.ios') or xbmc.getCondVisibility('system.platform.osx'):
	...
	Addons = "http://teamtugawizard.net23.net/README.xml"
	...
	JarvisWiz = "http://teamtugawizard.net23.net/JarvisWiz.xml"
	JarvisCheck = "http://teamtugawizard.net23.net/JarvisCheck.xml"
	JarvisUpdate = "http://teamtugawizard.net23.net/JarvisUpdate.xml"
	KryptonWiz = "http://teamtugawizard.net23.net/KryptonWiz.xml"
	KryptonCheck = "http://teamtugawizard.net23.net/KryptonCheck.xml"
	KryptonUpdate = "http://teamtugawizard.net23.net/KryptonUpdate.xml"
	BetaWiz = "http://teamtugawizard.net23.net/BetaWiz.xml"
	BetaVIPWiz = "http://teamtugawizard.net23.net/BetaVIPWiz.xml"
	BetaVIP = "http://teamtugawizard.net23.net/BetaVIP.xml"
	BetaKeys = "http://teamtugawizard.net23.net/BetaKeys.xml"
	SpeedTest = "http://teamtugawizard.net23.net/SpeedTest.xml"
	AdvancedSettings = "http://teamtugawizard.net23.net/AdvancedSettings.xml"
	JarvisOne = "http://teamtugawizard.net23.net/JarvisOne.xml"
	JarvisTwo = "http://teamtugawizard.net23.net/JarvisTwo.xml"
	KryptonOne = "http://teamtugawizard.net23.net/KryptonOne.xml"
