...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'plugin.program.jogosEmuladores')
...
AddonID='plugin.program.jogosEmuladores'
AddonTitle="Jogos Emuladores"
MaintTitle="Jogos Emuladores"
...
EXCLUDES     = ['Database','cache','temp','backupdir','plugin.program.jogosEmuladores','repository.tdbegley.official',"kodi.log","kodi.log.old","spmc.log","spmc.log.old"]
...
zip = 'special://home/addons/plugin.program.jogosEmuladores'
urlbase      =  'None'
