...
EXCLUDES     = ['plugin.program.jogosEmuladores','script.module.addon.common','repository.tdbegley.official','script.module.requests','temp','kodi.log','kodi.log.old','spmc.log','spmc.log.old']
