...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[plugin.video.vod.tvsupertuga-%s]: %s" %(addon_version, string))
...
class NoRedirection(urllib2.HTTPErrorProcessor):
   ...
   https_response = http_response
addon = xbmcaddon.Addon('plugin.video.vod.tvsupertuga')
Q1RWQmFzZQ0K = base64.b64decode('aHR0cDovL2JpdC5seS8yZEp4Zm5ibmJudm5oZmpra2h2YnZiY3hjenhFQQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
Q125xgFzZ76K = base64.b64decode('aHR0cDovL2JpdC5seDhoKnbNJjuJKIiioiyhNJHJMDdAZHNPQ2gzjenhFQQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL4JpdCgseS8yZHNPQ2dC5seF8yZHjPQ2gzjenhgzjenhFQQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL2JLdC5JjuJKIiseS8y5HMDdAZHPQpra2h2Yn2gzjenhFQQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL2JpdC9seS8yPQ2gzjenhFQDovL28yZHjPQ2gzJpdC5seQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovDovL2JpdC5seL8yZHjPQ2g7JpdC5seF8yZHjPQ2gzjenhFQQ==')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
